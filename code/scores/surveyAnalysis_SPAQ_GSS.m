function [ scoreTable, valuesTable, summaryMeasureFieldName ] = surveyAnalysis_SPAQ_GSS( T )
...
summaryMeasureFieldName='Rosenthal_1984_SPAQ_GSS';

questions={'ToWhatDegreeDoTheFollowingChangeWithTheSeasons__A_LengthOfSleep',...
'ToWhatDegreeDoTheFollowingChangeWithTheSeasons__B_SocialActivit',...
'ToWhatDegreeDoTheFollowingChangeWithTheSeasons__C_Mood_overallW',...
'ToWhatDegreeDoTheFollowingChangeWithTheSeasons__D_Weight_',...
'ToWhatDegreeDoTheFollowingChangeWithTheSeasons__E_Appetite_',...
'ToWhatDegreeDoTheFollowingChangeWithTheSeasons__F_EnergyLevel_'};


textResponses={'No Change (0)',...
'Slight Change (1)',...
'Moderate Change (2)',...
'Marked Change (3)',...
'Extremely Marked Change (4)'};
